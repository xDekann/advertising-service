...
CREATE TABLE IF NOT EXISTS `serwis_ogloszeniowy`.`offer_report` (
  ...
  INDEX `reported_offer_id_idx` (`reported_offer_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `serwis_ogloszeniowy`.`subscriptions` (
  ...
  PRIMARY KEY (`sub_id`),
  INDEX `subbed_offer_id_idx` (`subbed_offer_id` ASC) VISIBLE,
  INDEX `subbing_user_id_idx` (`subbing_user_id` ASC) VISIBLE,
